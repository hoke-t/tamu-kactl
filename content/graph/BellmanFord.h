 ...
 * Assumes $V^2 \max |w_i| < \tilde{} 2^{63}$. To detect negative-weight cycles without regard for
 * starting vertex, remove parameter $s$, set all initial node distances to zero, and remove the final
 * loop of bellmanFord.
 * Time: O(VE)
